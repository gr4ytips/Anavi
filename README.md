...
This project is licensed under the _[choose a license, e.g., MIT, Apache 2.0]_.  
A copy of the license should be placed in a `LICENSE` file in the root directory.

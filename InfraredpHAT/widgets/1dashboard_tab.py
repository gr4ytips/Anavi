...
class DashboardTab(QWidget):
    ...
    def __init__(self, data_store, thresholds, main_window, theme_colors, initial_gauge_type, initial_gauge_style, parent=None):
        ...
        self.matplotlib_widget = MatplotlibWidget(parent=self, theme_colors=self.theme_colors)
        ...
        for sensor_type in display_order:
            if sensor_type in configured_sensors:
                for metric_type in configured_sensors[sensor_type]:
                    ...
                    # Pass a reference to the specific metric's thresholds from the global dictionary
                    # This allows SensorDisplayWidget to react to global threshold changes
    ...
    def initialize_tab_data(self, theme_colors):
        ...
        # Ensure plot itself gets theme colors by updating its internal theme_colors and calling apply_theme
        self.matplotlib_widget.theme_colors.update(theme_colors)
